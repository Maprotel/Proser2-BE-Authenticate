...
global.__basedir = __dirname; // Dual database strategy
...
boot(app, __dirname); // app.engine('handlebars', hbs.engine);
// app.set('view engine', 'handlebars');
// app.set('views', path.resolve(__dirname, 'views'));
// configure view handler

app.set("view engine", "ejs");
app.set("views", path.join(__dirname, "views")); // app.set('view engine', handlebars); // LoopBack comes with EJS out-of-box
...
app.start = function () {
  ...
  return app.listen(function () {
    ...
    if (app.get("loopback-component-explorer")) {
      ...
      console.clear();
      console.log("");
      console.log(chalk.hex("#E5E510")("/*********************** PROSER *************************/"));
      console.log("System Proser by Maprotel", version);
      console.log("Environment: ", chalk.hex("#E5E510")(process.env.NODE_ENV));
      console.log("Authentication DB: ", chalk.hex("#E5E510")(process.env.AUTHENTICATION_DB_NAME));
      console.log("Browse your REST API at %s%s", baseUrl, explorerPath);
      console.log("");
      console.log(chalk.hex("#E5E510")("/********************************************************/"));
    }
  });
